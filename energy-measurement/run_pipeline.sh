...
IMAGE_NAME="orange3-medicao"
MEDICAO_DIR="$HOME/experimentos/medicao/repositorios/orange3"
...
TIME_FILE="/tmp/orange3_time_$$.txt"
...
measure_stage() {
  ...
  /usr/bin/time -f "%e" -o "$TIME_FILE" \
    docker run --rm --privileged --network none \
      --add-host datasets.biolab.si:127.0.0.1 \
